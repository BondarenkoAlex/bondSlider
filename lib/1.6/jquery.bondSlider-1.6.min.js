...
(function($){
    $.fn.bondSlider=function(options){
        ...
        var defaults={
            ...
            hideBtn: false,
            hideBtnOpacity: 0,
            hideBtnSpeed: c.fade.fast,
            speedOpacity: c.fade.slow,
            speedRotate: c.fade.slow,
            typeBtn: c.type.rotator,
            typeThumb: c.type.rotator,
            typeAutoPlay: c.type.rotator,
            typeScroller: c.typeLay.hor,
            autoPlayDirect: c.direct.next,
            effBtn: "linear",
            effThumb: "linear",
            effAutoPlay: "linear",
        ...
        options.speedOpacity = c.speeds[ options.speedOpacity ] || options.speedOpacity;
        options.speedRotate = c.speeds[ options.speedRotate ] || options.speedRotate;
        var this$=this;
        ...
        var animMove = function (pos, eff) {
            if (pos == null) return;
            if (options.typeScroller == c.typeLay.hor)
                contentFrames$.stop().animate({left:-pos.left}, options.speedRotate, eff);
            else if (options.typeScroller == c.typeLay.vert)
        ...
        var initialization = (function(){
            ...
            if ( options.typeScroller == c.typeLay.vert ){
        ...
        var bindEvent = (function(){
            ...
            if ( thumbs$ != null ){
                thumbs$.each( function(index, element){
                    ...
                    function action(){
                        ...
                        goTo(options.activeFrame, c.typeBtn.navi);
            ...
            function next(type){
                if ( !(options.distance == null) ){
                    goTo(c.direct.next, c.typeBtn.btn);
                    return;
                }
                options.activeFrame++;
                ...
                goTo( options.activeFrame, (type == null)? c.typeBtn.btn : type );
            }
            function prev(type){
                if ( !(options.distance == null) ){
                    goTo(c.direct.prev, c.typeBtn.btn);
                    return;
                }
                options.activeFrame--;
            ...
            function playAutoPlay(){
                if ( options.autoPlay == true ){
                    memory.autoPlayTimer = setInterval( function(){
                        if (options.autoPlayDirect == c.direct.prev) {
                            prev(c.typeBtn.auto);
                            callbackBtnNavi("prev");
                        }
                        else {
